...
public class ArrayEx {
	...
	public static void main(String[] args) {
		...
		// 특정 인덱스의 배열 요소 졉근 : 인덱스는 0부터
		System.out.println("배열의 첫 번째요소:" + numbers[0]);
		System.out.println("배열의  번째요소:" + numbers[1]);
		System.out.println("배열의 마지요소:" + numbers[numbers.length-1]);
